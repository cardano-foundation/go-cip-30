...
- The package imported: `import cip30 "github.com/cardano-foundation/go-cip-30"`.

Fully runnable versions of these snippets are in the
[package examples](https://pkg.go.dev/github.com/cardano-foundation/go-cip-30#pkg-examples).
